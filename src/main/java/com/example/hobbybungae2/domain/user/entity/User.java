...
import com.example.hobbybungae2.domain.userProfile.dto.UserProfileUpdateRequestDto;
import com.example.hobbybungae2.domain.userProfile.entity.UserHobby;
...
public class User extends TimeStamp {
	...
	@OneToMany(targetEntity = UserHobby.class, fetch = FetchType.EAGER, mappedBy = "user")
